    ...
    function changeTheme(val) {
        ...
        if (val == "dark") {
            head.className = "navbar navbar-expand-lg navbar-dark bg-dark fixed-top overflow-hidden";
            ...
            head.className = "navbar navbar-expand-lg navbar-light bg-light fixed-top overflow-hidden";
